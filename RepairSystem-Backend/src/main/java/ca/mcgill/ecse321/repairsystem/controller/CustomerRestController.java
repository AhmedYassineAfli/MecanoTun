...
public class CustomerRestController {
	...
	public CustomerDto createCustomer(@PathVariable("name") String name, @RequestParam String password,
			@RequestParam String phone, @RequestParam String email, @RequestParam String address)
			throws IllegalArgumentException, ParseException {
		Customer customer = customerService.createCustomer(name, password, Long.parseLong(phone), email, address);
	...
	public CustomerDto editCustomer(@PathVariable("oldEmail") String oldEmail, @RequestParam String newName,
			@RequestParam String newPassword, @RequestParam String newPhone, @RequestParam String newAddress)
			throws IllegalArgumentException {
		Customer customer = customerService.updateAllCredentials(oldEmail, newName, newPassword, newPhone, newAddress);
		return Converter.convertToDto(customer);
	}
