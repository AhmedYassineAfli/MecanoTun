...
public class RepairSystemRepository {
	...
	@Transactional
	public Customer createCustomer(String aName, int id, String aPassword, int aPhone, String aEmail, String address) {
		Customer c = new Customer(aName, id, aPassword, aPhone, aEmail, address);
		entityManager.persist(c);
		return c;
	}

	@Transactional
	public AdministrativeAssistant createAdministrativeAssistant(String aName, int id, String aPassword, int aPhone,
			String aEmail, Calendar lastActive) {
	...
	@Transactional
	public Mechanic createMechanic(String aName, int id, String aPassword, int aPhone, String aEmail,
			List<Service> allCapabilities) {
