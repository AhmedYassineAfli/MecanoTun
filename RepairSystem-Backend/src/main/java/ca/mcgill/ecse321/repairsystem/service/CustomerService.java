...
public class CustomerService {
	 ...
	 */
	@Transactional
	public Customer createCustomer(String aName, String aPassword, long aPhone, String aEmail, String add) {
		...
		Customer customer = new Customer(aName, id, aPassword, aPhone, aEmail, add);
	 ...
	 */
	@Transactional
	public Customer updateAllCredentials(String email, String name, String newPassword, String newPhone,
			String newAddress) {
		Customer customer = customerRepository.findByEmail(email);
	...
	public void editAppointments(String customerId, String appointmentId, String addRemove) {
		...
		Appointment appointment = appointmentRepository.findById(Integer.parseInt(appointmentId)).orElse(null);
		if (appointment == null) {
			throw new NullPointerException("Car does not exist");
		}
		Customer customer = getCustomerById(Integer.parseInt(customerId));
